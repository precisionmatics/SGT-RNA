"""
RNA-PDFL  ·  Step 3: Persistent Directed Flag Laplacian Feature Extraction
...
Output:
  data/features/step03_pdfl_features.npz  — X (n×3600) and y (n,) arrays
...
log.info("=" * 70)
log.info("RNA-PDFL  ·  Step 3: PDFL Feature Extraction")
log.info("=" * 70)
...
log.info(f"\nExtracting {N_FEATS}-dim PDFL features ...")
n = len(records)
...
# ── save features ─────────────────────────────────────────────────────────────
out_npz = OUT_DIR / "step03_pdfl_features.npz"
...
feat_csv = OUT_DIR / "step03_pdfl_features_head.csv"
...
fig.suptitle("RNA-PDFL  |  Step 3: 3600-dim PDFL Feature Matrix Overview",
...
ax2.set_title("RNA-PDFL  |  Step 3: Top 20 Features Correlated with pKd",
...
fig3.suptitle(
    f"RNA-PDFL  |  Eigenvalue Distributions — Best Pair: RNA-{best_r_el}×Lig-{best_l_el}\n"
